...
- [TypeScript client reference](https://docs.shodai.network/sdks/typescript-client.md): Reference the `@shodai-network/agreements-api-client` constructor, methods, signing helpers, diagnostics, path helpers, and exports.
