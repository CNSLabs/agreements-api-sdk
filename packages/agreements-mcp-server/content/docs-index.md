...
> SDK-first Agreements API documentation for authoring agreement JSON, validating deployments, signing permits, deploying agreements, and submitting signed inputs.
...
- [Author Agreement JSON](https://docs.shodai.network/authoring/author-agreement-json.md): Learn how to make good authoring decisions when turning a real business workflow into agreement JSON.
- [Validate Agreement Structure](https://docs.shodai.network/authoring/validate-agreement-structure.md): Check authored agreement JSON, read validation feedback, and distinguish template validation from deployment preflight.
...
- [Quickstart](https://docs.shodai.network/quickstart.md): Install the TypeScript client, create an authenticated API client, make your first SDK calls, or copy an agent prompt for an end-to-end workflow.
