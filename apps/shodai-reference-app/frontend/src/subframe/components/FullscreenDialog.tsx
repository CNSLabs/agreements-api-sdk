...
/*
 * Documentation:
 * Fullscreen Dialog — https://app.subframe.com/345c49081508/library?component=Fullscreen+Dialog_3f094173-71de-4378-a09a-05c482f7a137
 */
    ...
    <SubframeCore.FullScreenDialog.Root asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "z-[100] flex h-full w-full flex-col items-start bg-default-background",
          className
        )}
        ref={ref}
      >
