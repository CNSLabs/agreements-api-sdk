...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/345c49081508/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
...
const TabsRoot = React.forwardRef<HTMLDivElement, TabsRootProps>(
  function TabsRoot(
    { children, variant = "option-1", className, ...otherProps }: TabsRootProps,
    ref
  ) {
    return (
      <div
