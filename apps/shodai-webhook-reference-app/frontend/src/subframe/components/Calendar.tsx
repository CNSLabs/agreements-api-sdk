...
const CalendarRoot = React.forwardRef<
  ...
  CalendarRootProps
>(function CalendarRoot({ className, classNames, ...otherProps }: CalendarRootProps, ref) {
  return (
